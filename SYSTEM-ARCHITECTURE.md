...
This document describes the **technical architecture** of the DIU Skyward marketing site and **where each piece of on-screen text is defined** in the codebase.
