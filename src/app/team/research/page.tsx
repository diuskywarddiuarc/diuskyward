...
const RESEARCH_TEAM = [
    { name: "null", title: "Chief Research Officer", image: "/media/images/team/tahfim-bin-faisal.jpg" },
    { name: "null", title: "Simulation Engineer", image: "/media/images/team/mehedi-hasan.jpg" },
    { name: "null", title: "Data Scientist", image: "/media/images/team/tanvir-hossain.jpg" },
    { name: "null", title: "Experimental Physicist", image: "/media/images/team/fatima-tuz-zohra.jpg" },
];
        ...
        <div className="flex flex-col w-full bg-rl-black min-h-screen">
            ...
            <section className="relative py-40 overflow-hidden flex flex-col items-center justify-center text-center w-full">
                <div className="absolute inset-0 z-0">
                    ...
                    <div
                        className="absolute inset-0 bg-[url('/media/images/research-lab.png')] bg-cover bg-center bg-fixed opacity-50"
                    />
                </div>
            ...
            <section className="py-20 px-6 max-w-[1400px] mx-auto w-full">
                <div className="max-w-3xl mb-20 mx-auto text-center">
                    <p className="text-xl text-rl-light-grey font-light leading-relaxed mb-6">
                        The Research Division provides the academic and theoretical foundation for all DIU Skyward projects. Our researchers handle mathematical modeling, computational fluid dynamics (CFD), and experimental data processing to ensure mission success.
                    </p>
                    <p className="text-xl text-rl-light-grey font-light leading-relaxed">
                        We collaborate across divisions to validate designs through rigorous scientific methodology and peer-reviewed analysis.
                    </p>
                </div>
            </section>
