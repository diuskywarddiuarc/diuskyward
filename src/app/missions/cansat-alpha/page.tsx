...
import { Play, Navigation, CloudLightning, ShieldCheck } from "lucide-react";
import Link from "next/link";

export default function CanSatAlphaPage() {
    return (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-40">
                        <div>
                            <h2 className="text-5xl md:text-7xl font-heading font-black mb-10 tracking-tight leading-none uppercase">
                                Telemetry<br />Acquisition
                            </h2>
                        </div>
                        <div className="flex flex-col justify-center">
                            <p className="text-xl md:text-2xl text-rl-light-grey font-light leading-relaxed mb-8">
                                To prepare for the National CanSat Competition, the team is conducting a high-altitude drone drop simulating the deployment of our 350g cylindrical payload.
                            </p>
                            <div className="grid grid-cols-2 gap-8 pt-8 border-t border-rl-white/20">
                                <div>
                                    <span className="block text-4xl font-heading font-bold mb-2">Q3 2026</span>
                                    <span className="text-rl-light-grey text-sm tracking-widest uppercase">Target Launch Window</span>
                                </div>
                                <div>
                                    <span className="block text-4xl font-heading font-bold mb-2">800m</span>
                                    <span className="text-rl-light-grey text-sm tracking-widest uppercase">Release Altitude</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-40">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 border-y border-rl-white/20">
                            <div className="p-10 border-b md:border-b-0 md:border-r border-rl-white/20 group hover:bg-rl-dark-grey transition-colors">
                                <CloudLightning className="w-12 h-12 text-rl-white mb-8" strokeWidth={1} />
                                <h3 className="text-2xl font-heading font-bold uppercase mb-4 tracking-widest">SENSING</h3>
                                <p className="text-rl-light-grey font-light leading-relaxed">
                                    Accurately sample atmospheric pressure, temperature, and orientation (pitch/yaw/roll) throughout the entire drop sequence.
                                </p>
                            </div>

                            <div className="p-10 border-b md:border-b-0 md:border-r border-rl-white/20 group hover:bg-rl-dark-grey transition-colors">
                                <Navigation className="w-12 h-12 text-rl-white mb-8" strokeWidth={1} />
                                <h3 className="text-2xl font-heading font-bold uppercase mb-4 tracking-widest">GROUND STATION</h3>
                                <p className="text-rl-light-grey font-light leading-relaxed">
                                    Verify our Python-based GUI can render the telemetry packets in real-time, plotting altitude and a live 3D representation of the CanSat.
                                </p>
                            </div>

                            <div className="p-10 group hover:bg-rl-dark-grey transition-colors">
                                <ShieldCheck className="w-12 h-12 text-rl-white mb-8" strokeWidth={1} />
                                <h3 className="text-2xl font-heading font-bold uppercase mb-4 tracking-widest">DESCENT</h3>
                                <p className="text-rl-light-grey font-light leading-relaxed">
                                    Validate the passive auto-gyro mechanical deployment ensures a stable descent rate of under 15 m/s.
                                </p>
                            </div>
                        </div>
                    </div>
